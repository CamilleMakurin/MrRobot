...
@Getter
@Setter
public class KeyRelease implements ExecutableAction {
    private int keyCode;
    ...
    public void execute(Robot robot) {
        ...
        robot.delay(600);
        System.out.println("Key Release " + keyCode + ", " + NativeKeyEvent.getKeyText(keyCode));
    }
    ...
    public void setAttributes(Map<ActionAttribute, String> attributes) {
        System.out.println("KeyRelease has not attributes");
    }
}
