mapboxgl.accessToken = 'pk.eyJ1IjoiY2FtaWxsZW1ha3VyaW4iLCJhIjoiY2t0ajJrZm92MTduMzMwcGVxZzl0bWd2OSJ9.4vbtVhNFrJW_Fuj9DrLJxA';
...
var map;
try {
    //var style = 'mapbox://styles/camillemakurin/ckv29e2r03irw14o58gmqwcn0';
...
form.latInput.addEventListener('change', function() {
    'use strict';
    console.log("input lon: " + form.lonInput.value + " class: " + typeof form.lonInput.value)
    console.log("input lat: " + form.latInput.value + " class: " + typeof form.latInput.value)
    ...
    renderMap.once('idle', function() {
        if (format == 'png') {
            renderMap.getCanvas().toBlob(function(blob) {
                ...
                /*const fileStream = streamSaver.createWriteStream('map.png', {
